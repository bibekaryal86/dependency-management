...
public class MigrationConstants {
  ...
  public static final String ENV_DB_HOST_OLD = "DB_HOST_OLD";
  public static final String ENV_DB_NAME_OLD = "DB_NAME_OLD";
  public static final String ENV_DB_USER_OLD = "DB_USERNAME_OLD";
  public static final String ENV_DB_PWD_OLD = "DB_PASSWORD_OLD";
}
